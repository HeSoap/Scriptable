...
async function setupSunrise() {
    ...
    if (!todaySunDataRaw || !tomorrowSunDataRaw || resetWidget) {
        ...
        const tomorrowSunReq = "https://api.heweather.net/v7/astronomy/sunmoon?location=" + locationData.longitude + "," + locationData.latitude + "&key=" + apiKey + "&lang=zh&date=" + tomorrow.getFullYear() + (tomorrow.getMonth() + 1) + tomorrow.getDate()
